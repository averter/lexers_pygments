...
class apdlexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            ("(" + "|".join(elafunc) + r')\b',  Keyword),
            ("(" + "|".join(elafund) + r')\b',  Keyword),
            ("(" + "|".join(elafune) + r')\b',  Keyword),
            ("(" + "|".join(elafunf) + r')\b',  Name.Builtin),
            ("(" + "|".join(elafung) + r')\b',  Name.Builtin),
            ("(" + "|".join(elafunh) + r')\b',  Keyword),
            include('core'),
